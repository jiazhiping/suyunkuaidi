...
<html>
			...
			var toolbar = [ {
				...
				handler : function(){
					...
					if(rows.length != 1){
						...
						//4.回显数据
						$('#editStandardForm').form('load', rows[0]);
					}
				}
			},{
				id : 'button-delete',
	...
	<body class="easyui-layout" style="visibility:hidden;">
		...
		<!-- 收派标准修改界面 -->
		<div class="easyui-window" title="对收派标准进行添加或者修改" id="editStandardWindow" collapsible="false" minimizable="false" maximizable="false" modal="true" closed="true" style="width:600px;top:50px;left:200px">
			<div region="north" style="height:31px;overflow:hidden;" split="false" border="false">
				<div class="datagrid-toolbar">
